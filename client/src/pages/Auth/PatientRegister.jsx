                    ...
                    <div class="col-md-6 right-box">
                        <div class="row align-items-center">
                            <div class="header-text mb-2">
                                <h2>Welcome</h2>
                                <p>Are you a <span class="badge bg-primary"><Link to='/doctorregister' className='text-white' style={{ textDecoration: 'none' }}>Doctor</Link></span> |  <span class="badge bg-primary"><Link to='/vendorregister' className='text-white' style={{ textDecoration: 'none' }}>Vendor</Link></span></p>
                            </div>
                            ...
                            <div class="input-group d-flex flex-row align-items-center mb-3">
                                <div class="form-outline flex-fill mb-0">
                                    <input type="number" value={age} onChange={(e) => setAge(e.target.value)} class="form-control form-control-lg border-dark fs-6" placeholder="Pincode" required />
                                </div>
                            </div>
